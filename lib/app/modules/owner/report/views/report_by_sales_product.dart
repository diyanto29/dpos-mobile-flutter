...
class ReportBySalesProductView extends StatefulWidget {
  @override
  _ReportBySalesProductViewState createState() =>
      _ReportBySalesProductViewState();
}

class _ReportBySalesProductViewState extends State<ReportBySalesProductView> {
  ...
  List<Widget> _getTitleWidget() {
    return [
      _getTitleItemWidget('nama_produk'.tr, 250),
