              ...
              child: Row(
                ...
                children: [
                  Flexible(
                    ...
                    child: Row(
                      children: [
                        if(transactionController.auth.value.roleName != "Pemilik Toko")
                          IconButton(onPressed: () => _scaffoldKey.currentState!.openDrawer(), icon: Icon(Icons.menu, color: Colors.white,)),
                        Flexible(
                          child: Padding(
                  ...
                  GetBuilder<TransactionController>(builder: (logic) {
                    return Flexible(
                        flex: 1,
                        child: logic.listTransaction.length == 0 ? IconButton(
                          onPressed: () {},
                          ...
                          badgeContent: Text("${logic.listTransaction.length}"),
                          child: IconButton(
                      ...
                      Expanded(
                          ...
                          child: Obx(() {
                            return transactionController.searchC.value.text.isEmpty
                                ...
                                itemBuilder: (c, i) {
                                  return Card(
                                    color: controller.listProduct[i].productInCart ? MyColor.colorOrangeLight : null,
                                    elevation: 0.4,
                                      ...
                                      child: Stack(
                                        children: [
                                          ...
                                          Positioned(
                                              ...
                                              child: Container(
                                                width: 100,
                                                decoration: BoxDecoration(borderRadius: BorderRadius.only(topLeft: Radius.circular(10), bottomRight: Radius.circular(10)), color: Colors.green),
                              ...
                              child: Text("Produk Kosong"),
                                ...
                                itemBuilder: (c, i) {
                                  return Card(
                                    color: transactionController.listSearchProduct[i].productInCart ? MyColor.colorOrangeLight : null,
                                    elevation: 0.4,
                                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                                    child: InkWell(
                                      onTap: () {
                                      ...
                                      child: Stack(
                                        children: [
                                          ...
                                          ...cartController.listCart.map((element) {
                                            if (transactionController.listSearchProduct[i].productInCart && element.dataProduct == transactionController.listSearchProduct[i])
                                              return Positioned(
                                                child: Align(
                                                  alignment: Alignment.center,
                                                  child: Container(
                      ...
                      Expanded(
                          ...
                          child: Column(
                            children: [
                              Container(
                                width: double.infinity,
                                decoration: BoxDecoration(color: MyColor.colorPrimary, borderRadius: BorderRadius.only(topLeft: Radius.circular(10), topRight: Radius.circular(10))),
                                        ...
                                        child: MediaQuery.removePadding(
                                          ...
                                          child: ListView.builder(
                                              ...
                                              itemBuilder: (c, i) =>
                                                  InkWell(
                                                    onTap: () {
                                                      addDiscount(cart: cartController.listCart[i], allProduct: false);
                                                                  ...
                                                                  children: [
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        InkWell(
                                                                          onTap: () {
                                                                            cartController.deleteCart(cartModel: cartController.listCart[i]);
                                                                            FocusScopeNode currentFocus = FocusScope.of(context);
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Flexible(
                                                    flex: 7,
                                                    child: GeneralButton(
                                                      label: "Bayar Rp ${formatCurrency.format(cartController.totalShopping.value)}",
                                                      borderRadius: 5,
                                                      onPressed: () {
