...
class BottomDialogOutletReport extends StatefulWidget {
  const BottomDialogOutletReport({Key? key}) : super(key: key);

  @override
  State<BottomDialogOutletReport> createState() => _BottomDialogOutletReportState();
}

class _BottomDialogOutletReportState extends State<BottomDialogOutletReport> {
