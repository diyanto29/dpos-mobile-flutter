...
import 'package:warmi/app/modules/wigets/package/dropdown__search/select_dialog.dart';
import 'package:warmi/core/globals/global_color.dart';

import 'custom_show_menu.dart';
...
class DropdownSearchState<T> extends State<DropdownSearch<T?>> {
  ...
  Future<T?> _openBottomSheet(T? data) {
    return showModalBottomSheet<T>(
        ...
        context: context,
        builder: (ctx) {
          return _selectDialogInstance(data, defaultHeight: 500);
        });
  }
