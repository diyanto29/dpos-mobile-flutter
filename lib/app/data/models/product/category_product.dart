...
CategoryProductModel CategoryProductFromJson(String str) => CategoryProductModel.fromJson(json.decode(str));

String CategoryProductToJson(CategoryProductModel data) => json.encode(data.toJson());
